...
service_time_last_2 = 0;
service_time_last_3 = 0;
service_time_last_4 = 0;
service_time_last_5 = 0;
kolvo_cashbox = 5;
...
if service_time_f >= service_time_last_2
     money_buyer = rav_rasp(500);
    service_time_last_1 = service_time_t;
else
if service_time_f >= service_time_last_3
     money_buyer = rav_rasp(500);
    service_time_last_1 = service_time_t;
else
if service_time_f >= service_time_last_4
     money_buyer = rav_rasp(500);
    service_time_last_1 = service_time_t;
else
if service_time_f >= service_time_last_5
     money_buyer = rav_rasp(500);
    service_time_last_1 = service_time_t;
else
